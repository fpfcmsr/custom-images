...
dnf -y install plasma-bigscreen-wayland plasma-oxygen oxygen-icon-theme fcitx5 fcitx5-qt fcitx5-gtk fcitx5-configtool kcm-fcitx5 fcitx5-lua libime fcitx5-chinese-addons flashrom kmail
